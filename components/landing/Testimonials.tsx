          ...
          >
            {[...testimonials, ...testimonials].map(
              (testimonial, testimonialIndex) => (
                <div
                  key={`${testimonial.name}_${testimonialIndex}`}
                  className="border border-white/15 p-6 md:p-10 rounded-xl bg-[linear-gradient(to_bottom_left,rgb(0,123,156,.8),black)] max-w-xs md:max-w-md flex-none"
                >
                  <span className="text-lg tracking-tight md:text-2xl">
                    {testimonial.text}
                  </span>
                  <div className="flex items-center gap-3 mt-5">
                    <div className="relative after:content-[''] after:absolute after:inset-0 after:bg-[rgb(0,123,156,.8)] after:mix-blend-soft-light before:content-[''] before:inset-0 before:border before:border-white/30 before:z-10 before:rounded-lg">
                      <Image
